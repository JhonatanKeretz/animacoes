<template>
    ...
    <transition name="fade" appear>
     ...
     <transition name="slide" appear>
       <b-alert variant="info" show v-if="exibir">{{ msg }}</b-alert> <!-- pode usar v-if ou v-show -->
     </transition>
  ...
  <b-select v-model="tipoAnimacao" class="mb-4">
    ...
    <option value="slide">Slide</option>
     ...
     <button @click="exibir2 = !exibir2">Alternar</button>
      ...
      @click="componenteSelecionado = 'AlertaAdv'">Advertência</b-button>
      </div>
...
export default {
  ...
  data(){
    return{
      alunos: ['Roberto', 'Julia', 'Jaine', 'Pedro'],
